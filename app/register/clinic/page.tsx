      ...
      <div className="w-full max-w-md bg-secondary rounded-lg p-8">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            <Label htmlFor="clinicName">Nombre de la Clínica Veterinaria:</Label>
            <Input id="clinicName" className="bg-white" required />
          </div>
          ...
          <div className="space-y-2">
            <Label>Foto de la Clínica Veterinaria:</Label>
            <div className="flex items-center gap-2">
              <div className="h-16 w-16 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden">
                <img src="/placeholder.svg?height=64&width=64" alt="Clinic" className="h-full w-full object-cover" />
              </div>
          ...
          <div className="border-t border-gray-200 my-4 pt-4">
            <h3 className="font-medium text-center mb-4">Personal especializado</h3>

            <div className="space-y-4 mb-4">
              <div className="space-y-2">
                <Label htmlFor="staffName">Nombre y apellido</Label>
                <Input id="staffName" className="bg-white" required />
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="staffServices">Servicios ofrecidos</Label>
                <Select required>
                  <SelectTrigger className="bg-white">
              ...
              <div className="space-y-2">
                <Label htmlFor="staffHours">Horario de atención</Label>
                <Select required>
                  <SelectTrigger className="bg-white">
